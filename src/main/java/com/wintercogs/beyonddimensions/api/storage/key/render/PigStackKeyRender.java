...
public final class PigStackKeyRender implements IStackRender
{
    public static final PigStackKeyRender INSTANCE = new PigStackKeyRender();

    private PigStackKeyRender()
    {
    }
    ...
    {
        gui.renderFakeItem(new ItemStack(Items.PIG_SPAWN_EGG), x, y);
    }
    ...
    {
        return PigStackKey.INSTANCE.getRenderStack().getName();
    }
