...
public class MenuUniversalRecipeTransfer implements IUniversalRecipeTransferHandler<DimensionsCraftMenu>
{
    ...
    {
        return TransferHelper.transferRecipe(getInputSources(container), container.storage.getStorage(), container.player.getInventory().getNonEquipmentItems(), recipeSlots, maxTransfer, doTransfer, true);
    }
