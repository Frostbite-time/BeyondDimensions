...
{
    public static final ItemCapability<ISourceCap, @Nullable Void> ITEM_SOURCE = ItemCapability.createVoid(ResourceLocation.tryBuild(BDConstants.MODID, "caps/ars_source"), ISourceCap.class);
