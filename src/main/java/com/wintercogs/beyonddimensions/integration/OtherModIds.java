...
public final class OtherModIds
{
    ...
    public static final String RS_MEK_INTEGRATION = "refinedstorage_mekanism_integration";
    public static final String INDUSTRIAL_FOREGOING_SOULS = "industrialforegoingsouls";
    public static final String SOULPLIED_ENERGISTICS = "soulplied_energistics";
    public static final String ARS_NOUVEAU = "ars_nouveau";
    public static final String ARS_ENG = "arseng";
    public static final String BOTANIA = "botania";
    public static final String APPBOT = "appbot";
