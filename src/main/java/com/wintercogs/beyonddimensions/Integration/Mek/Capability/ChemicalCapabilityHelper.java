...
public class ChemicalCapabilityHelper
{
    ...
    public static BlockCapability<Object, @Nullable Direction> CHEMICAL_BLOCK; //化学品能力
    ...
    static {
        try {
            ...
            CHEMICAL_BLOCK = (BlockCapability<Object, Direction>) BlockCapability.class
            ...
            CHEMICAL_ITEM = (ItemCapability<Object, Void>) ItemCapability.class
