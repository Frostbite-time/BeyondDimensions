...
public class BD_AE_BotaniaPlugin
{
    ...
    {
        AEHelper.ISTACK_TO_AEKEY_MAP.put(ManaStackType.ID, stackType -> Optional.of(ManaKey.KEY));
        AEHelper.AEKEY_TO_STACK_TYPE_MAP.put(ManaKeyType.TYPE, (key, amount) -> Optional.of(new ManaStackType(amount)));
    }
}
