package com.wintercogs.beyonddimensions.Integration.Botania.HudOverlay;
...
@EventBusSubscriber(modid = BeyondDimensions.MODID, value = Dist.CLIENT, bus = EventBusSubscriber.Bus.GAME)
