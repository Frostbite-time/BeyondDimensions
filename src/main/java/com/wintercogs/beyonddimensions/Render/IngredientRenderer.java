...
public class IngredientRenderer
{
    ...
    // 仅用于新生魔艺的魔源渲染
    public static final Material ARS_SOURCE = new Material(InventoryMenu.BLOCK_ATLAS, Identifier.fromNamespaceAndPath("ars_nouveau", "block/mana_still"));
    // 仅用于植物魔法的魔力渲染
    public static final Material BOTANIA_MANA = new Material(InventoryMenu.BLOCK_ATLAS, Identifier.fromNamespaceAndPath("botania", "block/mana_water"));
