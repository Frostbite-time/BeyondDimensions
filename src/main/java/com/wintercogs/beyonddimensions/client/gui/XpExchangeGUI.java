...
public class XpExchangeGUI extends BDBaseGUI<XpExchangeMenu>
{
    ...
    protected void init()
    {
        ...
        })
        {
            ...
            {
                iconMap.put(KeepModeState.WORKING, ResourceLocation.tryBuild(BDConstants.MODID, "widget/control_mode_ignore"));
                iconMap.put(KeepModeState.NOT_WORKING, ResourceLocation.tryBuild(BDConstants.MODID, "widget/control_mode_not_working"));
