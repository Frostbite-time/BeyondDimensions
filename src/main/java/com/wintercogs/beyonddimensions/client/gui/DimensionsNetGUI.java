...
public class DimensionsNetGUI<T extends DimensionsNetMenu> extends BDBaseGUI<T>
{
    ...
    protected void init()
    {
        ...
        //页面增减按钮
        addPageButton = new IconButton(0, 0, 16, 16, BeyondDimensions.makeId("widget/up_arrow"), button ->
        {
        ...
        removePageButton = new IconButton(0, 0, 16, 16, BeyondDimensions.makeId("widget/down_arrow"), button ->
        {
            if (menu.getLines() <= 2)
                return;
            menu.reduceLines();
...
//                });
    ...
    {
        craftButton = new IconButton(0, 0, 16, 16, BeyondDimensions.makeId("widget/craft_button"), button ->
        {
            saveTransferContext();
    ...
    {
        primaryNetSwitcherButton = new IconButton(0, 0, 16, 16, BeyondDimensions.makeId("widget/opposite_arrow"), button ->
        {
            saveTransferContext();
