...
public class DimensionsCraftGUI extends BDBaseGUI<DimensionsCraftMenu>
{

    private static final ResourceLocation GUI_TEXTURE = ResourceLocation.tryParse("beyonddimensions:textures/gui/dimensions_net_craft.png");
    ...
    @Override
    protected void init() {
        this.leftPos = (this.width - 176)/2; //宽度未考虑滚动条，以便展示出视觉更加正常的中心位置
        this.topPos = (this.height - 256)/2;

        // 初始化按钮组件
        sortButton = new SortMethodButton(this.leftPos+40+18*6,this.topPos+138-16-5,button ->
        {
        ...
        reverseButton = new ReverseButton(this.leftPos+40+18*6,this.topPos+138+5,button ->
        {
        ...
        // 初始化搜索方案
        this.searchField = new EditBox(getFont(), this.leftPos+20+26+10, this.topPos+5, 89, this.getFont().lineHeight+4, Component.translatable("wintercogs.beyonddimensions.dimensionsguisearch"));
    ...
    protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY)
    {
        ...
        guiGraphics.drawString(this.font, this.playerInventoryTitle, this.inventoryLabelX, 166, 4210752,false);
    }
