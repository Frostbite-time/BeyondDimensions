...
public class NetFurnaceGUI extends BDBaseGUI<NetFurnaceMenu>
{
    ...
    protected void init()
    {
        ...
        })
        {
            ...
            protected void initButton()
            {
                iconMap.put(AutoSortMode.OPEN, ResourceLocation.tryBuild(BeyondDimensions.MODID, "textures/gui/sprites/widget/sort_mode_open.png"));
                iconMap.put(AutoSortMode.STOP, ResourceLocation.tryBuild(BeyondDimensions.MODID, "textures/gui/sprites/widget/sort_mode_stop.png"));
