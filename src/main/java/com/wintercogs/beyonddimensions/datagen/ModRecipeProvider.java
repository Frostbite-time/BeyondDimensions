...
public class ModRecipeProvider extends BDRecipeProvider
{
    ...
    protected void buildRecipes(@NotNull RecipeOutput recipeOutput)
    {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, BDBlocks.NET_BLAST_FURNACE_BLOCK.get())
                .pattern("AAA")
                .pattern("BCB")
                .pattern("ADA")
                .define('A', Items.COBBLESTONE)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, BDBlocks.NET_SMOKER_BLOCK.get())
                .pattern("AAA")
                .pattern("BCB")
                .pattern("ADA")
                .define('A', Items.COBBLESTONE)
