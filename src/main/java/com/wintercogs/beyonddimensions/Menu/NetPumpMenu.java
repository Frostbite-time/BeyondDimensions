...
public class NetPumpMenu extends BDOrderedContainerMenu
{
    ...
    {
        super(UIRegister.Net_Pump_Menu.get(), containerId, playerInventory, storage);

        viewerFlagStorage = new StackTypedHandler(36);
        ...
        for(int row = 0; row < 4; row++)
        {
            ...
            {
                StoredStackSlot flagSlot = new StoredStackSlot(viewerFlagStorage, row*9+col, 8 + col * 18, slotStartY + row * 18);
