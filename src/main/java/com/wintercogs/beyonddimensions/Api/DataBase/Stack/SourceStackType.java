...
{
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(BeyondDimensions.MODID, "stack_type/source");
    public static final SourceStackType EMPTY = new SourceStackType(); // 空定义

    public static final MapCodec<SourceStackType> TYPE_CODEC = RecordCodecBuilder.mapCodec(instance ->
            instance.group(
                    SourceType.CODEC.fieldOf("internal_stack").forGetter(SourceStackType::getStack)
